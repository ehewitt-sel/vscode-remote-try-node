...
import { MiniLogoGeneratedModule, MiniLogoGeneratedSharedModule as MiniLogoGeneratedSharedModule } from './generated/module.js';
...
export type MiniLogoAddedServices = {
    validation: {
        MiniLogoValidator: HelloWorldValidator
    }
}
...
export const MiniLogoModule: Module<MiniLogoServices, PartialLangiumServices & MiniLogoAddedServices> = {
    validation: {
        MiniLogoValidator: () => new HelloWorldValidator()
    }
};
